                                ...
                                @forelse ($products as $product)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-100">
                                        ...
                                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300">
                                            <span class="px-2 py-1 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-xs font-medium">
                                                {{ $product->category->name ?? 'Uncategorized' }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 text-green-600 dark:text-green-500 font-medium">{{ $product->qty }}</td>
                                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300">
